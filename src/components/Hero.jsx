...
const getVideoSrc = (index) =>  `videos/hero-${index}.mp4`
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
        ...
        <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-hidden rounded-lg bg-blue-75'>
          <div>
            <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer 
                        ...
                        <h1 className='soecial-font hero-heading absolute bottom-5
